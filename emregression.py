...
pdf_pages = PdfPages('DMassiveHalos135.pdf')
...
import sqlite3
conn = sqlite3.connect('massivehalos.db')    #Here I will create a database of thousands of darkmatters

c = conn.cursor()   #my cursor

# Create table
c.execute('''CREATE TABLE  darkmassive135
...
for x in list_of_darkhalos:
	...
	query_string = 'INSERT INTO darkmassive135 VALUES (%s);' % halo_string
